...
class DotaStatus:
    ...
    def showStatus(self):
        ...
        try:
            ...
            image = GdkPixbuf.Pixbuf.new_from_file(self.DIR + self.server_cases[title][1])
        except:
            notification = Notify.Notification.new(self.server_cases['Steambd'][0])
            image = GdkPixbuf.Pixbuf.new_from_file(self.DIR + self.server_cases['Steambd'][1])
